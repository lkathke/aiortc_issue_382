...
from aiortc import MediaStreamTrack, RTCPeerConnection, RTCSessionDescription, VideoStreamTrack, RTCRtpSender
...
class VideoTransformTrack(VideoStreamTrack):
    ...
    async def recv(self):
        ...
        new_frame = VideoFrame.from_ndarray(frame2, format="bgr24")
...
async def offer(request):
    ...
    track = pc.addTrack(VideoTransformTrack())
    pc.addTrack(FlagVideoStreamTrack())
